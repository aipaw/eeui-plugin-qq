...
import static eeui.android.tencent.entry.tencentEntry.mTencent;
...
public class ApptencentModule extends WXModule {
    ...
    public void login(final JSCallback callback) {
            ...
            public void onComplete(Object response) {
                ...
                try {
                    ...
                    if (!TextUtils.isEmpty(token) && !TextUtils.isEmpty(expires) && !TextUtils.isEmpty(openId)) {
                        ...
                        data.put("create_at", eeuiCommon.timeStamp());
                    }
        ...
        mActivity.setPageStatusListener("__extendTencent", new JSCallback() {
            ...
            public void invokeAndKeepAlive(Object data) {
                ...
                if (retData != null && eeuiParse.parseStr(retData.get("status")).equals("activityResult")) {
    ...
    public void getUserInfo(final JSCallback callback) {
        ...
        mInfo.getUserInfo(new IUiListener() {
            ...
            public void onComplete(Object response) {
                ...
                com.alibaba.fastjson.JSONObject data = eeuiJson.parseObject(response);
                data.put("status", "success");
                data.put("body", "获取成功");
                callback.invoke(data);
            }
    ...
    public void share(com.alibaba.fastjson.JSONObject json, JSCallback callback) {
        ...
        final IUiListener baseUiListener = new IUiListener() {
            ...
            public void onComplete(Object response) {
                ...
                Map<String, Object> data = new HashMap<>();
                data.put("status", "success");
                data.put("body", eeuiJson.parseObject(response));
                finalCallback.invoke(data);
            }
        ...
        params.putString(QQShare.SHARE_TO_QQ_TITLE, eeuiJson.getString(json, "title"));
        params.putString(QQShare.SHARE_TO_QQ_TARGET_URL, eeuiJson.getString(json, "url"));
        params.putString(QQShare.SHARE_TO_QQ_SUMMARY, eeuiJson.getString(json, "desc"));
        params.putString(QQShare.SHARE_TO_QQ_IMAGE_URL, eeuiJson.getString(json, "imgUrl"));
    ...
    public void shareToQzone(com.alibaba.fastjson.JSONObject json, final JSCallback callback) {
        ...
        params.putString(QQShare.SHARE_TO_QQ_SUMMARY, eeuiJson.getString(json, "desc"));
        //
        JSONArray array = eeuiJson.parseArray(json.get("imgUrl"));
        if (array.size() == 0 && !TextUtils.isEmpty(eeuiJson.getString(json, "imgUrl"))) {
            array.add(eeuiJson.getString(json, "imgUrl"));
        }
        ArrayList<String> imageUrls = new ArrayList<String>();
        for (int i = 0; i < array.size(); i++) {
            imageUrls.add(eeuiParse.parseStr(array.get(i)));
        }
